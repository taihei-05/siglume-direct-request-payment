...
- Standard Payment の返金は self-service refund API で扱います。Micro / Nano の調整は、アカウントで提供される Siglume support / platform process で扱います。
