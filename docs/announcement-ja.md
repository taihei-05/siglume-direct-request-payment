...
| JPY 50-500 / USD 0.31-3.00 | Micro Payment / マイクロペイメント | 選択不要。金額で自動適用 | JPY 2 / USD 0.01 per SDRP Tx | **週次**でまとめて精算（[精算スケジュール](#精算スケジュール)参照） |
| JPY 1-49 / USD 0.01-0.30 | Nano Payment / ナノペイメント | 選択不要。金額で自動適用 | JPY 0.2 / USD 0.001 per SDRP Tx | **月次**でまとめて精算（[精算スケジュール](#精算スケジュール)参照） |
